...
struct Statement
    : qi::grammar<Iterator, ast::StatementList(), Skipper<Iterator>>
{
    Statement(ErrorHandler<Iterator>& errorHandler);

    Expression<Iterator> expr;
    qi::rule<Iterator, ast::StatementList(), Skipper<Iterator>>
        CompoundStatement;
    ...
    qi::rule<Iterator, ast::VariableDeclaration(), Skipper<Iterator>>
        VariableDeclaration;
    ...
    qi::rule<Iterator, ast::ReturnStatement(), Skipper<Iterator>>
        ReturnStatement;
