                       ...
                       std::vector<int>::iterator frame_ptr) -> int
{
    ...
    while (pc != code.end())
    {
        ...
        switch (*pc++)
        {
            ...
            case op_not: stack_ptr[-1] = !bool(stack_ptr[-1]); break;
            ...
            case op_load: *stack_ptr++ = frame_ptr[*pc++]; break;
            ...
            case op_true: *stack_ptr++ = true; break;

            case op_false: *stack_ptr++ = false; break;

            case op_jump: pc += *pc; break;
            ...
            case op_stk_adj: stack_ptr = stack.begin() + *pc++; break;
            ...
            case op_return: return stack_ptr[-1];
        }
    }
    return -1;
}
