...
auto CreateAdditionAssembly(tcc::Integer const argument) -> std::vector<tcc::Integer>
{
    using tcc::ByteCode;
    return std::vector<tcc::Integer>{
...
auto CreateFactorialAssembly(tcc::Integer const argument) -> std::vector<tcc::Integer>
{
    using tcc::ByteCode;
    return std::vector<tcc::Integer>{
...
auto CreateFibonacciAssembly(tcc::Integer const argument) -> std::vector<tcc::Integer>
{
    using tcc::ByteCode;
    return std::vector<tcc::Integer>{
...
auto CreateMultipleArgumentsAssembly(tcc::Integer const firstArg, tcc::Integer const secondArg)
...
auto CreateMultipleFunctionsAssembly(tcc::Integer const argument) -> std::vector<tcc::Integer>
{
    using tcc::ByteCode;
    return std::vector<tcc::Integer>{
