...
public:
    ...
    static auto IsUnusedStatement(IRStatement const& statement,
                                  IRStatementList const& statementList) -> bool;
    static auto ReplaceVariableIfConstant(IRStatement& statement,
    ...
    static auto isConstantArgument(IRStatement::Argument const& argument)
        -> bool;
    static auto
    isConstantArgument(IRStatement::OptionalArgument const& argument) -> bool;
    static auto isConstantStoreExpression(IRStatement const& statement) -> bool;
    static auto isConstantBinaryExpression(IRStatement const& statement)
        -> bool;
