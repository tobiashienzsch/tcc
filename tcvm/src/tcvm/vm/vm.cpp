  ...
  while (static_cast<size_t>(m_instructionPointer) < m_code.size()) {
    ...
    switch (opcode) {
      ...
      case ByteCode::ICONST: {
        auto const val =
            m_code.at(m_instructionPointer);  // read operand from code
      ...
      case ByteCode::CALL: {
        ...
        auto const numArgs =
            m_code[m_instructionPointer++];          // how many args got pushed
      ...
      case ByteCode::RET: {
        ...
        auto const numArgs =
            m_stack.at(m_stackPointer--);  // how many args to throw away
      ...
      case ByteCode::EXIT:
        return m_stack.at(m_stackPointer);
      case ByteCode::HALT:
        return -1;
    }
  }
